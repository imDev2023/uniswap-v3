...
**Suites** (verify, do not trust): `forge test` (210), `cd subgraph && npm test` (36) both re-measured green on 2026-08-10; `cd frontend && npm test` is **592 in 44 files** as of #43 (2026-08-11), plus `tsc -b` and `vite build`.
