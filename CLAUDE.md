...
**Suites** (verify, do not trust): all re-measured green on 2026-08-10 - `forge test` (210), `cd subgraph && npm test` (36), `cd frontend && npm test` (499, 41 files) plus `tsc -b` and `vite build`.
